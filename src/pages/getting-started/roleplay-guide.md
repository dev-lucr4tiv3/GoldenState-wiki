...
**Du weißt nur, was dein Charakter weiß.**
...
Diese zwei Befehle sind das Herzstück guten Roleplays.

`/me schaut sich nervös um, bevor er die Tür öffnet.`
...
- Andere bestimmen lassen was passiert ohne Reaktionschance (Powergaming)
- Töten ohne Kontext (RDM)
- Überfahren ohne Kontext (VDM)
- Stadt verlassen mitten in einer Szene (Combat Logging)

## Wenn etwas schiefläuft

Kein Problem. Frag im Discord oder drück `F5`. Niemand erwartet Perfektion.
